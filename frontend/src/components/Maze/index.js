...
function Maze(props) {  
    ...
    const draw = g => { // removed useCallback because map is only drawn once
        ...
        for(let y = 0; y < maze.height; y++) {
            for(let x = 0; x < maze.width; x++) {
                ...
                if( (maze.grid[y][x] & N) === 0 ) {
                    if( maze.sx === x && (maze.sy === y || maze.sy === y-1) )      g.lineStyle(LARGE_LINE_WIDTH, 0x00ff00, 1)
                    else if( maze.ex === x && (maze.ey === y || maze.ey === y-1) ) g.lineStyle(LARGE_LINE_WIDTH, 0xff0000, 1)
                    else g.lineStyle(LARGE_LINE_WIDTH, 0xffffff, 1)
                ...
                if( (maze.grid[y][x] & W) === 0 ) {
                    if( (maze.sx === x || maze.sx === x-1) && maze.sy === y )      g.lineStyle(LARGE_LINE_WIDTH, 0x00ff00, 1)
                    else if( (maze.ex === x || maze.ex === x-1) && maze.ey === y ) g.lineStyle(LARGE_LINE_WIDTH, 0xff0000, 1)
                    else g.lineStyle(LARGE_LINE_WIDTH, 0xffffff, 1)
        ...
        g.lineStyle(LARGE_LINE_WIDTH, 0x00ff00, 1)
        ...
        g.lineStyle(LARGE_LINE_WIDTH, 0xff0000, 1)
